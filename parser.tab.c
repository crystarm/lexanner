...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KW_FLOAT = 13,                  /* KW_FLOAT  */
  YYSYMBOL_KW_STRING = 14,                 /* KW_STRING  */
  YYSYMBOL_KW_BOOL = 15,                   /* KW_BOOL  */
  YYSYMBOL_KW_RETURN = 16,                 /* KW_RETURN  */
  YYSYMBOL_KW_VAR = 17,                    /* KW_VAR  */
  YYSYMBOL_KW_THEN = 18,                   /* KW_THEN  */
  YYSYMBOL_KW_STEP = 19,                   /* KW_STEP  */
  YYSYMBOL_KW_TO = 20,                     /* KW_TO  */
  ...
  YYSYMBOL_COLON_ASSIGN = 27,              /* COLON_ASSIGN  */
...
static const char *const yytname[] =
{
  ...
  "KW_IF", "KW_ELSE", "KW_WHILE", "KW_FOR", "KW_DO", "KW_PRINT", "KW_READ",
  "KW_INT", "KW_FLOAT", "KW_STRING", "KW_BOOL", "KW_RETURN", "KW_VAR",
  "KW_THEN", "KW_STEP", "KW_TO", "BOOL_LITERAL", "IDENTIFIER",
  "INT_LITERAL", "FLOAT_LITERAL", "STRING_LITERAL", "ASSIGN",
